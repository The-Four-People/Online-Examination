					...
					<div className="body-contd">
						...
						<div className="main-container">
							<div className="main-info">
										...
										<tr>
											...
											<td>
												...
												<button
													...
													onClick={() => setTDate(!tDate)}
												>
													{tDate ? <AiOutlineClose /> : <AiFillEdit />}
												</button>
											</td>
										</tr>
										<tr>
											...
											<td>
												...
												<button
													...
													onClick={() => setTTime(!tTime)}
												>
													{tTime ? <AiOutlineClose /> : <AiFillEdit />}
												</button>
											</td>
										</tr>
										<tr>
											...
											<td>
												{tDuration ? (
													...
													`${Math.floor(test.duration)} hr ${
														(test.duration - Math.floor(test.duration)) * 60
													} mins`
												)}
											</td>
											<td>
												...
												<button
													...
													onClick={() => setTDuration(!tDuration)}
												>
													{tDuration ? <AiOutlineClose /> : <AiFillEdit />}
												</button>
											</td>
										</tr>
									</tbody>
								...
								>
									<Link to={`/c/${courseCode}/${testCode}/result`}>
...
const DisplayIndividualQuestion = ({ question, codeTest, getTest }) => {
	...
	const handleClick = () => {
		fetch(`${process.env.REACT_APP_BASE_URI}/api/course/update/${codeTest}/`, {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
				Authorization: `bearer ${JSON.parse(localStorage.getItem("token"))}`,
