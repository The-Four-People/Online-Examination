...
const {
    ...
    courseId,
    updateCourse,
} = require('./Routes/Course/courseIndex');

const { searchCourse, searchUser } = require('./Routes/Search/searchIndex');
...
app.use('/api/course/update', hasToken, updateCourse);

//Search Router
app.use('/api/search/course', hasToken, searchCourse);
app.use('/api/search/', hasToken, searchUser);
